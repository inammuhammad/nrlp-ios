...
class BeneficiaryVerificationViewModelTest: XCTestCase {
    ...
    func testOTPCode() {
        let viewModel = BeneficiaryVerificationViewModel(service:APIKeyServiceDecorator(decoratee: BeneficiaryVerificationServicePositiveMock(), appKeyService: AppKeyServiceMock()), router: router, model: getRegisterRequestMock())
    ...
    func testNextButtonPressedNegative() {
        var viewModel = BeneficiaryVerificationViewModel(service: APIKeyServiceDecorator(decoratee: BeneficiaryVerificationServiceNegativeMock(), appKeyService: AppKeyServiceMock()), router: router, model: getRegisterRequestMock())
        ...
        viewModel = BeneficiaryVerificationViewModel(service: APIKeyServiceDecorator(decoratee: BeneficiaryVerificationServiceNegativeMock(), appKeyService: AppKeyServiceMock()), router: router, model: getRegisterRequestMock())
