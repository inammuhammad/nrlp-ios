...
class RemitterVerificationViewModelTest: XCTestCase {
    ...
    func testVerificationPossitive() {
        let viewModel: RemitterVerificationViewModel = RemitterVerificationViewModel(service:     APIKeyServiceDecorator(decoratee: RemitterVerificationServicePositiveMock(), appKeyService: AppKeyServiceMock()), router: router, model: commonRegisterModel)
    ...
    func testVerificationNegativeAPI() {
        let viewModel: RemitterVerificationViewModel = RemitterVerificationViewModel(service: APIKeyServiceDecorator(decoratee: RemitterVerificationServiceNegativeMock(), appKeyService: AppKeyServiceMock()), router: router, model: commonRegisterModel)
        let outputHandler = RemitterVerificationViewModelOutputHandler(viewModel: viewModel)
