...
class ForgotPasswordViewModelTests: XCTestCase {
    ...
    func testAccountTypePicker() {
        let viewModel = ForgotPasswordViewModel(router: router, service: APIKeyServiceDecorator(decoratee: ForgotPasswordServicePositiveMock(), appKeyService: AppKeyServiceMock()))
    ...
    func testNextButtonPressedNegative() {
        let viewModel = ForgotPasswordViewModel(router: router, service: APIKeyServiceDecorator(decoratee: ForgotPasswordServiceNegativeMock(), appKeyService: AppKeyServiceMock()))
