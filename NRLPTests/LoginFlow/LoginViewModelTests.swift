...
class LoginViewModelTests: XCTestCase {
    ...
    func testLoginButtonPressedPositive() {
        ...
        var loginViewModel: LoginViewModelProtocol = LoginViewModel(service: LoginServicePositiveMock(), router: router)
    ...
    func testLoginAPINegativeLocalError() {
        let loginViewModel = LoginViewModel(service: LoginServiceNegativeMock(), router: router)
        let loginViewModelOutputHandler = LoginViewModelOutputHandler(loginViewModel: loginViewModel)
        loginViewModel.paassword = "Password@123"
        loginViewModel.cnic = "4220133573111"
    ...
    func testRegisterButtonPressed() {
        let loginViewModel: LoginViewModelProtocol = LoginViewModel(service: LoginServicePositiveMock(), router: router)
