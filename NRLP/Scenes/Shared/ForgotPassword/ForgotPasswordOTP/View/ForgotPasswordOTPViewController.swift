...
class ForgotPasswordOTPViewController: BaseViewController {
    ...
    var viewModel: ForgotPasswordOTPViewModelProtocol!
    ...
    @IBAction
    private func didTapResentButton(_ sender: Any) {
        clearInputFields()
        viewModel.didTapOnResendOtpButton()
    }
}

extension ForgotPasswordOTPViewController: KWTextFieldDelegate {
...
extension ForgotPasswordOTPViewController: Initializable {
    static var storyboardName: UIStoryboard.Name {
        return UIStoryboard.Name.forgotPasswordOTP
    }
}
