...
class RemitterVerificationViewModel: RemitterVerificationViewModelProtocol {
    ...
    private var service: RemitterVerificationServiceProtocol
    ...
    init(service: RemitterVerificationServiceProtocol,
    ...
    func nextButtonPressed() {
        ...
        service.verifyCode(requestModel: requestModel) { [weak self] (result) in
